function outstruct = i_noMessTDN_BHE_KABBA_getwaveformdataextern(networkin, stationin, locationin, channelin, sdn_start, sdn_end, ... % necessary
                                           varargin)
...
if ~isempty(outstruct)
    ...
    outstruct = i_noMessTDN_BHE_sensitivities_count2groundmotiondata(outstruct,SEEDcalibpath);
